$( function() {
    ...
    var trafficSound = new buzz.sound( 'sounds/sound' ),
        clickSound = new buzz.sound( 'sounds/otro' ),
        focusSound = new buzz.sound( 'sounds/otro' ),
        rewindSound = new buzz.sound( 'sounds/otro' ),
